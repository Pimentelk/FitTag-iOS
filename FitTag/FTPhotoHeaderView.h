...
typedef enum {
    FTPhotoHeaderButtonsNone = 0,
    FTPhotoHeaderButtonsLike = 1 << 0,
    FTPhotoHeaderButtonsComment = 1 << 1,
    FTPhotoHeaderButtonsUser = 1 << 2,
    
    FTPhotoHeaderButtonsDefault = FTPhotoHeaderButtonsLike | FTPhotoHeaderButtonsComment | FTPhotoHeaderButtonsUser
} FTPhotoHeaderButtons;

@protocol FTPhotoHeaderViewDelegate;

@interface FTPhotoHeaderView : UIView
...
@property (nonatomic, readonly, assign) FTPhotoHeaderButtons buttons;
...
/*! @name Delegate */
@property (nonatomic,weak) id <FTPhotoHeaderViewDelegate> delegate;
 ...
 */
@protocol FTPhotoHeaderViewDelegate <NSObject>
@optional
