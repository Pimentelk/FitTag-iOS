...
@implementation FTPhotoHeaderView
...
- (id)initWithFrame:(CGRect)frame buttons:(FTPhotoHeaderButtons)otherButtons {
    self = [super initWithFrame:frame];
    if (self) {
        
        NSLog(@"FTPhotoHeaderView::initWithFrame");
        
        [FTPhotoHeaderView validateButtons:otherButtons];
        ...
        if (self.buttons & FTPhotoHeaderButtonsComment) {
            // comments button
        ...
        if (self.buttons & FTPhotoHeaderButtonsLike) {
            // like button
        ...
        if (self.buttons & FTPhotoHeaderButtonsUser) {
...
+ (void)validateButtons:(FTPhotoHeaderButtons)buttons {
    if (buttons == FTPhotoHeaderButtonsNone) {
...
- (void)didTapUserButtonAction:(UIButton *)sender {
    if (delegate && [delegate respondsToSelector:@selector(photoHeaderView:didTapUserButton:user:)]) {
        [delegate photoHeaderView:self didTapUserButton:sender user:[self.photo objectForKey:kFTPhotoUserKey]];
    }
}
