...
@interface FitTagLoginViewController ()
...
@implementation FitTagLoginViewController
...
- (void)viewDidLayoutSubviews {
    ...
    [self.loginHex setFrame:CGRectMake([self getCenterX: 206.0f],118.0f,206.0f,238.0f)];
