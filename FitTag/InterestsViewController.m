...
@interface InterestsViewController ()<UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout>
{
...
- (void)submitUserInterests
{
    if( selectedInterests.count < 3){
        ...
        if(user){
            ...
            // Show the interests
            InspirationViewController *rootViewController = [[InspirationViewController alloc] initWithCollectionViewLayout:layoutFlow];
