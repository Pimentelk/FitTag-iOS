...
#import "FTCamEngine.h"
#import "FTVideoEncoder.h"
#import "AssetsLibrary/ALAssetsLibrary.h"

static FTCamEngine *theEngine;

@interface FTCamEngine  () <AVCaptureVideoDataOutputSampleBufferDelegate, AVCaptureAudioDataOutputSampleBufferDelegate> {
...
+ (void) initialize
{
    ...
    if (self == [FTCamEngine class])
    {
        theEngine = [[FTCamEngine alloc] init];
    }
}
